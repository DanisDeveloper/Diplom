  ...
  <div v-else>
    ...
    <div class="tabs-wrapper">
        ...
        <div class="shader-grid">
          ...
          >
            ...
            <div class="shader-cell__info">
              ...
              <div class="info-row">
                <span class="info-label">Created at:</span> <span class="info-value">{{ formatDate(shader.created_at) }}</span>
              </div>
              <div class="info-row">
                <span class="info-label">Last update:</span> <span class="info-value">{{formatDate(shader.updated_at)}}</span>
              </div>
              <div class="info-row" :class="{'invisible' : shader.id_forked === null}">
                <span class="info-label">Forked:</span> <span class="info-value">{{ truncate(shader.forked_shader ? shader.forked_shader.title : "", 17) }}</span>
              </div>
      ...
      <div v-else-if="activeTab === 'Account'">
        ...
        <!-- TODO добавить здесь возможность изменить биографию пользователя-->
      </div>
