  ...
  <div class="main">
    <div class="canvas-container">
      ...
      <div class="canvas-footer">
        ...
        <div class="btns">
          ...
          <div class="right-btns">
            ...
            <button v-if="this.$store.state.isAuth" class="action-btn" @click="">
              <save-icon></save-icon>
            </button>
          </div>
        </div>
      ...
      <div v-if="isExpanded" class="description-area">
        <input class="shader-title" placeholder="Title">
        <textarea rows="5" class="shader-description" placeholder="Description"></textarea>
      </div>
