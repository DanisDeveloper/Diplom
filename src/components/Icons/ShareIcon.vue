<template>
  <svg :width="width" :height="height" viewBox="-1 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Icon-Set" transform="translate(-312.000000, -726.000000)" :fill="color">
        <path
